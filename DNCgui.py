...
layout = [[sg.Text("DNC Simulator")],
          ...
          [sg.Text("Critical Hit Rate",size=(14,1)), sg.Input(default_text=crit,size=(8,1),key='crit1',do_not_clear=True),sg.Text('',size=(12,1),key='crate1'),sg.Text("Critical Hit Rate",size=(14,1)), sg.Input(default_text='1967',size=(8,1),key='crit2',do_not_clear=True),sg.Text('',key='crate2',size=(12,1))],
          [sg.Text("Direct Hit",size=(14,1)), sg.Input(default_text=dh,size=(8,1),key='dh1',do_not_clear=True),sg.Text('',size=(12,1),key='direct1'),sg.Text("Direct Hit",size=(14,1)), sg.Input(default_text='1806',size=(8,1),key='dh2',do_not_clear=True),sg.Text('',key='direct2',size=(10,1))],
          ...
          [sg.Text("Fight", size=(14,1),tooltip='Determine fight breaks, if any'), sg.InputCombo(fightlist,key='fights'), sg.Text('',size=(1,1)),sg.Text('Create Log'),sg.Radio('Yes','LOGS',size=(3,1),key="logon"),sg.Radio('No','LOGS',size=(3,1),default=True,key='logoff')],
          [sg.Text("Length of Fight",tooltip='How long is the fight', size=(16,1)),sg.Input(default_text='300',size=(8,1),key='length')],
          [sg.Text("Run How many Times",tooltip='The Higher number, the longer and more accurate the sim is', size=(16,1)),sg.Input(default_text='200',size=(8,1),key='runtime')],
                ...
                if simtwoaction:
                    ...
                    while i > 0:
                        ...
                        if i > 5:
                            ...
                            jobruns = i
                        results = asyncio.run(runsim(jobruns,runlength,i,opener1,fight,simonetable,abilities,party,pbuffs,buffs,True,astpriority,logging))
                    ...
                    while i > 0:
                        ...
                        results = asyncio.run(
                            runsim(jobruns, runlength, i, opener2, fight, simtwotable, abilities, party, pbuffs,
                                   buffs, True, astpriority, logging))
                    ...
                    while i > 0:
                        ...
                        if i > 5:
                            ...
                            jobruns = i
                        results = asyncio.run(runsim(jobruns, runlength, (runtimes-i), opener1, fight, simonetable, abilities, party, pbuffs,buffs, True, astpriority, logging))
                        potency1 = potency1 + results
                        i = i - jobruns
                        bar.UpdateBar(runtimes - i)
                    progwin.Close()
